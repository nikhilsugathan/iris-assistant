...
class Config:
    ...
    BACKGROUND_ACTIONS_ENABLED = os.getenv("BACKGROUND_ACTIONS_ENABLED", "true").lower() == "true"
    BACKGROUND_ACTIONS_VOICE_ONLY = os.getenv("BACKGROUND_ACTIONS_VOICE_ONLY", "true").lower() == "true"
    ...
    RUNTIME_LOG_ENABLED = os.getenv("IRIS_RUNTIME_LOG_ENABLED", "true").lower() == "true"
    RUNTIME_LOG_FILE = os.getenv("IRIS_RUNTIME_LOG_FILE", os.path.join("build", "logs", "iris_runtime.log")).strip()
    RUNTIME_LOG_MAX_MB = int(os.getenv("IRIS_RUNTIME_LOG_MAX_MB", "5"))
    RUNTIME_LOG_BACKUPS = int(os.getenv("IRIS_RUNTIME_LOG_BACKUPS", "3"))
    BACKGROUND_UPDATE_HISTORY_LIMIT = int(os.getenv("BACKGROUND_UPDATE_HISTORY_LIMIT", "32"))
    ...
    WAKE_LOCAL_WHISPER_ACCEPT_CONFIDENCE = float(os.getenv("WAKE_LOCAL_WHISPER_ACCEPT_CONFIDENCE", "0.55"))
    WAKE_SYSTEM_ACCEPT_CONFIDENCE = float(os.getenv("WAKE_SYSTEM_ACCEPT_CONFIDENCE", "0.5"))
    ...
    SYSTEM_STT_MAX_LANGUAGES = int(os.getenv("SYSTEM_STT_MAX_LANGUAGES", "2"))
    WAKE_SYSTEM_MAX_LANGUAGES = int(os.getenv("WAKE_SYSTEM_MAX_LANGUAGES", "2"))
