...
def _apply_startup_defaults(Config) -> None:
    ...
    _ensure_attr(Config, "IRIS_STICKY_LANGUAGE_TTS", False)
...
def apply_config_hardening() -> None:
    ...
    # One consistent Iris character voice is the product default. Language-aware
    # STT and LLM response style stay enabled; TTS speaker switching is opt-in.
    Config.IRIS_STICKY_LANGUAGE_TTS = _env_bool("IRIS_STICKY_LANGUAGE_TTS", False)
